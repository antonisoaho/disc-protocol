export const commonEn = {
  ...
  profile: {
    ...
    teams: {
      ...
      hint: 'Save team groupings here. They appear when you start a scramble round and can be applied in the new-round wizard.',
      you: 'You',
      teamName: 'Team name',
      members: 'Members',
      addTeam: 'Add team',
      ...
      defaultName: 'Team {{number}}',
      unassigned_one: '{{count}} player not on a team yet',
      unassigned_other: '{{count}} players not on a team yet',
      noMembers: 'No members yet',
      clubTeamsTitle: 'Your club teams',
      clubTeamsHint: 'Teams managed by an admin that you belong to (read-only here).',
      clubTeamsAria: 'Club teams you belong to',
      clubTeamLine: '{{teamName}}: {{members}}',
      saved: 'Teams saved.',
      saveFailed: 'Could not save teams.',
    },
  },
  auth: {
    title: {
  ...
  scoring: {
    ...
    buttons: {
      ...
      selected: 'Selected',
      delete: 'Delete',
      completeRound: 'Finish round',
      completeRoundHint: 'This completes the whole round for everyone, not only the hole you are viewing.',
      completeRoundOwnerOnly: 'Only the player who started the round can mark it as completed.',
      saveLastHole: 'Save score',
    ...
    rounds: {
      ...
      noScores: 'no scores',
      roundTotal:
        'Round total {{totalStrokes}}/{{totalPar}} ({{totalDelta}}) · {{fullyScoredHoles}}/{{holeCount}} holes complete',
    ...
    stepper: {
      ...
      previousHoleAria: 'Previous hole',
    ...
    teamRows: {
      listAria: 'Team scoring rows',
      strokesForTeamAria: 'Strokes for {{teamName}}',
    },
    playerRows: {
    ...
    results: {
      winnerSingle: 'Winner: {{name}}',
      winnersTied: 'Winners: {{names}}',
      standingsAria: 'Final standings',
      resultLine: '{{name}} - {{strokes}} - ({{toPar}})',
      placeFirst: '1st place',
      placeSecond: '2nd place',
      placeThird: '3rd place',
  ...
  dashboard: {
    ...
    courseFilterAria: 'Filter statistics by course',
  ...
  rounds: {
    new: {
      ...
      wizard: {
        ...
        format: {
          title: 'How are you scoring?',
          individualTitle: 'Regular round',
          individualHint: 'Each player enters their own score on every hole.',
          scrambleTitle: 'Scramble',
          scrambleHint: 'One team score per hole. Assign players to teams below.',
          savedTeamsTitle: 'Your saved teams',
          savedTeamsHint: 'These presets are stored on your profile. Apply them to this round, then adjust if needed.',
          savedTeamsAria: 'Saved scramble team presets',
          savedTeamLine: '{{teamName}}: {{members}}',
          savedTeamNoMembers: 'No members yet',
          applySavedTeams: 'Apply saved teams',
          useSavedTeam: 'Use team',
          teamsDisclosureSummary: 'Set up teams',
          unknownPlayer: 'Unknown player',
        ...
        review: {
          ...
          players: 'Players',
          format: 'Format',
          formatIndividual: 'Regular round',
    ...
    scorecard: {
      ...
      backToPlayerNamed: '← Back to {{name}}',
